...
- `.amx` save and reload behavior is still being stabilized.
...
- The desktop app is not the priority yet.
...
```text
scratch-gui      Editor UI, stage integration, project pages, addons
...
desktop          Future desktop packaging path
