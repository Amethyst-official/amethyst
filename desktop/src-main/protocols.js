...
const FILE_SCHEMES = {
  ...
  'tw-update': {
    ...
    csp: "default-src 'none'; style-src 'unsafe-inline'; script-src 'unsafe-inline'; connect-src https://amethyst3d.pages.dev"
  },
  'tw-security-prompt': {
...
<html lang="en">
  ...
  <body bgcolor="white" text="black">
    ...
    <p>If you can see this page, <a href="https://github.com/Amethyst-official/amethyst/issues" target="_blank" rel="noreferrer">please open a GitHub issue</a> with all the information below.</p>
