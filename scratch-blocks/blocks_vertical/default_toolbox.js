...
Blockly.Blocks.defaultToolbox = '<xml id="toolbox-categories" style="display: none">' +
  '<category name="%{BKY_CATEGORY_MOTION}" id="motion" colour="#4C97FF" secondaryColour="#3373CC">' +
    '<block type="motion_movesteps" id="motion_movesteps">' +
      ...
      '</value>' +
    '</block>' +
    '<block type="motion_movesidewayssteps" id="motion_movesidewayssteps">' +
      '<value name="STEPS">' +
        '<shadow type="math_number">' +
          '<field name="NUM">10</field>' +
        '</shadow>' +
    ...
    '<block type="motion_sety" id="motion_sety">' +
      ...
      '</value>' +
    '</block>' +
    '<block type="motion_changezby" id="motion_changezby">' +
      '<value name="DZ">' +
        '<shadow type="math_number">' +
          '<field name="NUM">10</field>' +
        '</shadow>' +
      '</value>' +
    '</block>' +
    '<block type="motion_setz" id="motion_setz">' +
      '<value name="Z">' +
    ...
    '<block type="motion_zposition" id="motion_zposition"></block>' +
