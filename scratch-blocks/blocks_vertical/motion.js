...
Blockly.Blocks['motion_changezby'] = {
  /**
   * Block to change Z.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_CHANGEZBY,
      "args0": [
        {
          "type": "input_value",
          "name": "DZ"
...
Blockly.Blocks['motion_setz'] = {
  ...
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.MOTION_SETZ,
      "args0": [
        {
          "type": "input_value",
          "name": "Z"
...
Blockly.Blocks['scene3d_setcameraposition'] = {
  /**
   * Block to set the 3D camera position.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.SCENE3D_SETCAMERAPOSITION,
      "args0": [
        {
          "type": "input_value",
          "name": "X"
...
Blockly.Blocks['scene3d_pointcameraat'] = {
  /**
   * Block to point the 3D camera at a world position.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.SCENE3D_POINTCAMERAAT,
      "args0": [
        {
          "type": "input_value",
          "name": "X"
...
Blockly.Blocks['scene3d_setcamerafov'] = {
  /**
   * Block to set the 3D camera field of view.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.SCENE3D_SETCAMERAFOV,
      "args0": [
        {
          "type": "input_value",
          "name": "FOV"
...
Blockly.Blocks['scene3d_setambientlight'] = {
  /**
   * Block to set the 3D scene ambient light brightness.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.SCENE3D_SETAMBIENTLIGHT,
      "args0": [
        {
          "type": "input_value",
          "name": "BRIGHTNESS"
...
Blockly.Blocks['scene3d_setkeylight'] = {
  /**
   * Block to set the 3D scene key light brightness.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.SCENE3D_SETKEYLIGHT,
      "args0": [
        {
          "type": "input_value",
          "name": "BRIGHTNESS"
...
Blockly.Blocks['scene3d_setkeylightposition'] = {
  /**
   * Block to set the 3D scene key light position.
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      "message0": Blockly.Msg.SCENE3D_SETKEYLIGHTPOSITION,
      "args0": [
        {
          "type": "input_value",
          "name": "X"
