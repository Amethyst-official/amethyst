...
Blockly.Msg["SCENE3D_TURNCAMERALEFTRIGHTBY"] = "turn camera left/right by %1";
Blockly.Msg["SCENE3D_SETCAMERAFOV"] = "set camera zoom to %1";
Blockly.Msg["SCENE3D_SETCAMERASMOOTHINGDURATION"] = "set camera smoothing duration to %1";
Blockly.Msg["SCENE3D_SETAMBIENTLIGHT"] = "set ambient brightness to %1";
Blockly.Msg["SCENE3D_SETKEYLIGHT"] = "set sunlight brightness to %1";
Blockly.Msg["SCENE3D_SETSUNCOLOR"] = "set sun color to %1";
Blockly.Msg["SCENE3D_SETSUNANGLE"] = "set sunlight angle direction %1 height %2";
Blockly.Msg["SCENE3D_SETKEYLIGHTPOSITION"] = "put sun light at x: %1 y: %2 z: %3";
Blockly.Msg["SCENE3D_SETSKYCOLOR"] = "set sky color to %1";
Blockly.Msg["SCENE3D_SETGROUNDCOLOR"] = "set ground color to %1";
Blockly.Msg["SCENE3D_SETFOGAMOUNT"] = "set fog amount to %1";
Blockly.Msg["SCENE3D_SETENVIRONMENTPRESET"] = "set environment to %1";
Blockly.Msg["SCENE3D_SWITCHBACKDROP"] = "change stage to %1";
Blockly.Msg["SCENE3D_NEXTBACKDROP"] = "next stage";
