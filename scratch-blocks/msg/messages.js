...
Blockly.Msg.MOTION_GOTOXY = 'go to x: %1 y: %2 z: %3';
Blockly.Msg.MOTION_GLIDESECSTOXY = 'glide %1 secs to x: %2 y: %3 z: %4';
...
Blockly.Msg.MOTION_CHANGEZBY = 'change z by %1';
Blockly.Msg.MOTION_SETZ = 'set z to %1';
...
Blockly.Msg.MOTION_ZPOSITION = 'z position';
...
Blockly.Msg.SCENE3D_SETKEYLIGHTPOSITION = 'put sun light at x: %1 y: %2 z: %3';
...
Blockly.Msg.SOUND_SETSTEREOPAN = 'set stereo pan to %1';
Blockly.Msg.SOUND_CHANGESTEREOPANBY = 'change stereo pan by %1';
Blockly.Msg.SOUND_STEREOPAN = 'stereo pan';
