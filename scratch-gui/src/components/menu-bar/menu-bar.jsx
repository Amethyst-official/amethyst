    ...
    restoreOptionMessage (deletedItem) {
        ...
        case 'Sprite':
            return (<FormattedMessage
                defaultMessage="Restore Actor"
                description="Menu bar item for restoring the last deleted actor."
        ...
        case 'Costume':
            return (<FormattedMessage
                defaultMessage="Restore Model"
                description="Menu bar item for restoring the last deleted model."
                    ...
                    <div className={styles.fileGroup}>
                        {this.props.errors.length > 0 && <div>
                            ...
                            >
                                ...
                                >
                                    <MenuSection>
                                        <MenuItemLink href="https://github.com/Amethyst-official/amethyst/issues">
                                            <FormattedMessage
