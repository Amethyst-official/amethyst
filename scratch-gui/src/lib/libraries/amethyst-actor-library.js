...
const icon = (label, shape) => {
    const drawings = {
        ...
        cylinder: [
            ...
            '<path d="M26 32v64c0 8 17 14 38 14s38-6 38-14V32z" fill="#8169ff"/>',
            '<ellipse cx="64" cy="96" rx="38" ry="14" fill="#ad44df"/>'
        ].join(''),
        plane: [
            '<path d="M18 72l92-36v24L62 74l48 14v24z" fill="#8169ff"/>',
            '<path d="M62 74l-20 6 20 8 48-14z" fill="#e8b1ff" opacity=".75"/>'
        ].join(''),
        torus: [
            '<circle cx="64" cy="64" r="46" fill="#8169ff"/>',
        ...
        blank: [
            ...
            'stroke="#8169ff" stroke-width="8" stroke-dasharray="13 9"/>',
            '<path d="M64 45v38M45 64h38" stroke="#8169ff" stroke-width="8" stroke-linecap="round"/>'
        ].join('')
    };
