...
const defaultBlockPackages = {
    ...
    scratch3_scene3d: require('../blocks/scratch3_scene3d'),
    scratch3_mouse3d: require('../blocks/scratch3_mouse3d'),
    scratch3_network: require('../blocks/scratch3_network'),
    scratch3_media_display: require('../blocks/scratch3_media_display'),
...
class Runtime extends EventEmitter {
    constructor () {
        ...
        this.scratch3dScene = defaultBlockPackages.scratch3_scene3d.defaultSceneState();
